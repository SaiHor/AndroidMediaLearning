...
class AudioAdapter(private val activity: Activity) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {

    private var data: MutableList<AudioFileModel> = mutableListOf()

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int) =
        AudioItemViewHolder(ItemAudioBinding.inflate(activity.layoutInflater, parent, false))
